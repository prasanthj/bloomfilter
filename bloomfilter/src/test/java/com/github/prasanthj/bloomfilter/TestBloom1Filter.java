...
public class TestBloom1Filter {
  ...
  public void testBloomIllegalArg1() {
    Bloom1Filter bf = new Bloom1Filter(0, 0);
  }

  @Test(expected = AssertionError.class)
  public void testBloomIllegalArg2() {
    Bloom1Filter bf = new Bloom1Filter(0, 0.1);
  }

  @Test(expected = AssertionError.class)
  public void testBloomIllegalArg3() {
    Bloom1Filter bf = new Bloom1Filter(1, 0.0);
  }

  @Test(expected = AssertionError.class)
  public void testBloomIllegalArg4() {
    Bloom1Filter bf = new Bloom1Filter(1, 1.0);
  }

  @Test(expected = AssertionError.class)
  public void testBloomIllegalArg5() {
    Bloom1Filter bf = new Bloom1Filter(-1, -1);
  }


  @Test
  public void testBloomNumBits() {
    assertEquals(0, Bloom1Filter.optimalNumOfBits(0, 0));
    assertEquals(1549, Bloom1Filter.optimalNumOfBits(1, 0));
    assertEquals(0, Bloom1Filter.optimalNumOfBits(0, 1));
    assertEquals(0, Bloom1Filter.optimalNumOfBits(1, 1));
    assertEquals(7, Bloom1Filter.optimalNumOfBits(1, 0.03));
    assertEquals(72, Bloom1Filter.optimalNumOfBits(10, 0.03));
    assertEquals(729, Bloom1Filter.optimalNumOfBits(100, 0.03));
    assertEquals(7298, Bloom1Filter.optimalNumOfBits(1000, 0.03));
    assertEquals(72984, Bloom1Filter.optimalNumOfBits(10000, 0.03));
    assertEquals(729844, Bloom1Filter.optimalNumOfBits(100000, 0.03));
    assertEquals(7298440, Bloom1Filter.optimalNumOfBits(1000000, 0.03));
    assertEquals(6235224, Bloom1Filter.optimalNumOfBits(1000000, 0.05));
  }

  @Test
  public void testBloomNumHashFunctions() {
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(-1, -1));
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(0, 0));
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(10, 0));
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(10, 10));
    assertEquals(7, Bloom1Filter.optimalNumOfHashFunctions(10, 100));
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(100, 100));
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(1000, 100));
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(10000, 100));
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(100000, 100));
    assertEquals(1, Bloom1Filter.optimalNumOfHashFunctions(1000000, 100));
  }

  @Test
  public void testBloom1FilterBytes() {
    Bloom1Filter bf = new Bloom1Filter(10000);
  ...
  @Test
  public void testBloom1FilterByte() {
    Bloom1Filter bf = new Bloom1Filter(10000);
  ...
  @Test
  public void testBloom1FilterInt() {
    Bloom1Filter bf = new Bloom1Filter(10000);
  ...
  @Test
  public void testBloom1FilterLong() {
    Bloom1Filter bf = new Bloom1Filter(10000);
  ...
  @Test
  public void testBloom1FilterFloat() {
    Bloom1Filter bf = new Bloom1Filter(10000);
  ...
  @Test
  public void testBloom1FilterDouble() {
    Bloom1Filter bf = new Bloom1Filter(10000);
  ...
  @Test
  public void testBloom1FilterString() {
    Bloom1Filter bf = new Bloom1Filter(10000);
    String val = "bloo";
  ...
  public void testMerge() {
    ...
    Bloom1Filter bf2 = new Bloom1Filter(10000);
    String v = "2_bloo";
